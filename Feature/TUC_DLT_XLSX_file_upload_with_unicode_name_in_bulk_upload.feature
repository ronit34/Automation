Feature: TUC_DLT_XLSX_file_upload_with_unicode_name_in_bulk_upload

    Scenario: TUC_DLT_XLSX_file_upload_with_unicode_name_in_bulk_upload
        ...
        And choose xlsx unicode file for jio operator
