Feature: TUC_DLT_template_search_type_template_id_enter_sender_id_verify_error_label

    Scenario: TUC_DLT_template_search_type_template_id_enter_sender_id_verify_error_label
        ...
        And Enter sender id in template
