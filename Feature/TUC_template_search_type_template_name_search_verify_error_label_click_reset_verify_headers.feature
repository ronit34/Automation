Feature: TUC_template_search_type_template_name_search_verify_error_label_click_reset_verify_headers

    Scenario: TUC_template_search_type_template_name_search_verify_error_label_click_reset_verify_headers
