Feature: check for the text of the user profile in super admin
    ...
    Scenario: Login to Onextel localhost and check for the text of the user account in ICICI admi
...
#        Then Check if the message invalid login then close the browser
        And click on ICICIAdmin after which drop down menu will appear
