Feature: TUC_New_sms_quick_sms_using_group_scrub_DND_send_sms_and_verify_credits

    Scenario: TUC_New_sms_quick_sms_using_group_scrub_DND_send_sms_and_verify_credits
