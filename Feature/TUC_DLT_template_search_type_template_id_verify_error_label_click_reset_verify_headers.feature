Feature: TUC_DLT_template_search_type_template_id_verify_error_label_click_reset_verify_headers

    Scenario: TUC_DLT_template_search_type_template_id_verify_error_label_click_reset_verify_headers
