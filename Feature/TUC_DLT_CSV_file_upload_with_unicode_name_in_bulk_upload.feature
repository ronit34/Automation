Feature: TUC_DLT_CSV_file_upload_with_unicode_name_in_bulk_upload

    Scenario: TUC_DLT_CSV_file_upload_with_unicode_name_in_bulk_upload
        ...
        And choose csv unicode file for jio operator
