Feature: TUC_DLT_XLS_file_upload_with_special_char_name_in_bulk_upload

    Scenario: TUC_DLT_XLSX_file_upload_with_special_char_name_in_bulk_upload
        ...
        And choose xlsx file for jio operator
