...
@then(u'insert data into Dynamic sms for promo')
...
@then(u'check Scrub Dnd checkbox is selected in dynamic')
def step_impl(context):
    time.sleep(2)
    checkbox = context.driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[3]/div[2]/div[1]/div[3]/div[7]/div[2]/label[1]/input").is_selected()
    if checkbox == True :
        assert True
    else:
