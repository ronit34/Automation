...
@then(u'Verify char length showing on SMS window and confirmation window are same or not')
def step_impl(context):
    time.sleep(2)
    txt = context.driver.find_element(By.XPATH,
                                      "/html/body/div[1]/div[2]/div[3]/div[2]/div[1]/div/div[4]/div[1]/div/div/div/div[1]/div[1]/div/div/div/div[2]/div[2]/div[8]/div/p").text
