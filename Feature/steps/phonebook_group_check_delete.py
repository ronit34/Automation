...
@then(u'check the warning message is present')
def check_message(context):
    time.sleep(2)
    # text = context.driver.find_element_by_xpath("//*[@id='pills-campaign']/div[1]/div[2]/div/div/div/div[1]").text
