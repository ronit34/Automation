...
@then(u'insert short template data')
...
@then(u'click on split schedule and insert different time')
def step_impl(context):
    time.sleep(2)
    ...
    context.driver.find_element_by_xpath(
        "/html/body/div[1]/div[2]/div[3]/div[2]/div[1]/div/div[7]/div[2]/div[2]/input").send_keys("1")
    ...
    select.select_by_value(minutes)
    context.driver.find_element_by_xpath(
        "/html/body/div[1]/div[2]/div[3]/div[2]/div[1]/div/div[7]/div[3]/div[2]/input").send_keys("3")

@then(u'click on send of short recipient split schedule')
def step_impl(context):
    time.sleep(1)
...
@then(u'check change in credits after splitting short sms "{verify}"')
