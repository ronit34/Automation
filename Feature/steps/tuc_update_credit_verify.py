...
@then(u'Cross verify the Available Credits in Credits tab')
def step_impl(context):
    time.sleep(2)
    Availabe_Credit_tuc = context.driver.find_element_by_xpath("//*[@id='pills-campaign']/div[2]/table/tbody/tr[2]/td[2]").text
...
############# FILL THE tuc NAME ###############
    ...
    time.sleep(2)
    context.driver.find_element(By.ID, "searchTuc").send_keys("SALES")
