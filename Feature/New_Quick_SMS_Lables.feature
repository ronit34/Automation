...
#        Then Check if the message invalid login then close the browser
        ...
        And check if New SMS/Quick English SMS text is present or not
        And check the text of Quick SMS tab
        ...
        And check if DND Number text is present or not inside send button
        And check if Blacklisted Numbers text is present or not inside send button
