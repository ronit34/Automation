Feature: Report campaign summary filters
  ...
  Scenario: campaign summary report filters apply
    ...
    And click on senderID summary tab in report
...
#    And select to date "13042022"
    And fill wrong sender ID in filters
    And set limit and check pagination in senderID summary
#    And verify submitted count
    ################### DOWNLOAD FILE ###################
