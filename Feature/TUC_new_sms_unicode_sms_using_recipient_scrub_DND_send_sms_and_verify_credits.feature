Feature: TUC_new_sms_unicode_sms_using_recipient_scrub_DND_send_sms_and_verify_credits

    Scenario: TUC_new_sms_unicode_sms_using_recipient_scrub_DND_send_sms_and_verify_credits
