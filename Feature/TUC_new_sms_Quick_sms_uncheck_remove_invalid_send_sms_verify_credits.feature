Feature: TUC_new_sms_Quick_sms_uncheck_remove_invalid_send_sms_verify_credits

    Scenario: TUC_new_sms_Quick_sms_uncheck_remove_invalid_send_sms_verify_credits
