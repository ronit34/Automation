Feature: TUC_DLT_XLS_file_upload_with_unicode_name_in_bulk_upload

    Scenario: TUC_DLT_XLS_file_upload_with_unicode_name_in_bulk_upload
        ...
        And choose xls unicode file for jio operator
