Feature: check for the text of the user profile in tenant admin

  Scenario: Login to Onextel localhost and check for the text of the user account in Onexadmin
...
#        Then Check if the message invalid login then close the browser
        And click on Onexadmin after which drop down menu will appear
