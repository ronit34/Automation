Feature: split schedule using file and group in campaign sms
...
#        Then Check if the message invalid login then close the browser
        ...
        And click on split schedule with different time for campaign

         And click on send of short recipient split schedule
         And check change in credits after splitting short sms "26"
